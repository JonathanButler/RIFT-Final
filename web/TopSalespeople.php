...
$db_server = mysql_connect($db_hostname, $db_username, $db_password);
  ...
  $result = mysql_query("Select S.name, T.eid, sum(T.total_price) from Transaction T, Salesperson S where T.eid=S.eid Group By T.eid order by sum(T.total_price) desc limit 25");
