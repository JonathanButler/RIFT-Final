<?php  //This file is used for checking the businesses that are buying given products the most.
...
$db_server = mysql_connect($db_hostname, $db_username, $db_password);
 ...
 //$proQuery = "SELECT SUM(quantity), SUM(price) FROM Invoice, Product, WHERE name = $proName GROUP BY region";
